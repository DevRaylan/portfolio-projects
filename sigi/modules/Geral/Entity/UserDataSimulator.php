 ...
 */
class UserDataSimulator implements UserDataInterface
{
    /**
     ...
     * Utilizado para limitar o número de contas criadas em caso de login sem dados encontrados.
     */
    private $createdOnLogin;
    ...
    {
        $this->isPrincipal = $isPrincipal == 'true' ? true : false;
    ...
    /**
     * Get utilizado para limitar o número de contas criadas em caso de login sem dados encontrados.
     */ 
    public function getCreatedOnLogin()
    {
        return $this->createdOnLogin;
    }

    /**
     * Set utilizado para limitar o número de contas criadas em caso de login sem dados encontrados.
     *
     * @return  self
     */ 
    public function setCreatedOnLogin($createdOnLogin = null)
    {
        $this->createdOnLogin = $createdOnLogin == 'true' ? true : false;
