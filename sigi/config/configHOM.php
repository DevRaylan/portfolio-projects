...
* No apache deve estar setada a constante AMBIENTE para "HOM".
...
// Chave para deploy no ambiente de Homologação via Jenkins, pode ser solicitado ao Setor de Datacenter/SETIC.
